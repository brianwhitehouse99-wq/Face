...
export default function GameScreen({ athletes, filters, onFinish, onHome, challengerName, challengerScore }: Props) {
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-yellow-400 hover:text-yellow-300 transition-colors text-2xl font-bold"
              title="Back to home"
            >
              ←
            </button>
        ...
        {showConfirm && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 px-4">
            <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-6 w-full max-w-sm">
              <p className="text-white font-bold text-lg mb-2">Quit this game?</p>
              <p className="text-zinc-400 text-sm mb-6">Your progress will be lost.</p>
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => { setShowConfirm(false); onHome?.() }}
                  className="flex-1 py-3 bg-yellow-400 hover:bg-yellow-300 text-black font-semibold rounded-xl transition-all"
                >
                  Quit
                </button>
              </div>
